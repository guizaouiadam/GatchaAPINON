...
public class InvocationService {
    ...
    public Invocation invokeMonster(String token) {
        String userId = getUserIdByToken(token); // renverra une erreur si le token est invalide

        // 1. Sélectionner un monstre aléatoire en fonction des probabilités
        ...
        // 2. Transmettre les informations du monstre à l'API des monstres
        ...
        // 3. Sauvegarde temporaire de l’invocation
        ...
        // 4. Ajouter le monstre au joueur
        try {
